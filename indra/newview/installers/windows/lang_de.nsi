...
LangString DirectoryChooseUpdate ${LANG_GERMAN} "Wählen Sie den MikoStorm Ordner für dieses Update:"
LangString DirectoryChooseSetup ${LANG_GERMAN} "Pfad in dem MikoStorm installiert werden soll:"

LangString MUI_TEXT_DIRECTORY_TITLE ${LANG_GERMAN} "Installationsverzeichnis"
LangString MUI_TEXT_DIRECTORY_SUBTITLE ${LANG_GERMAN} "Wählen Sie das Verzeichnis aus, in dem MikoStorm installiert werden soll:"

LangString MUI_TEXT_INSTALLING_TITLE ${LANG_GERMAN} "MikoStorm wird installiert..."
LangString MUI_TEXT_INSTALLING_SUBTITLE ${LANG_GERMAN} "MikoStorm wird im Verzeichnis $INSTDIR installiert"

LangString MUI_TEXT_FINISH_TITLE ${LANG_GERMAN} "MikoStorm wird installiert"
LangString MUI_TEXT_FINISH_SUBTITLE ${LANG_GERMAN} "MikoStorm wurde im Verzeichnis $INSTDIR installiert."

LangString MUI_TEXT_ABORT_TITLE ${LANG_GERMAN} "Installation abgebrochen"
LangString MUI_TEXT_ABORT_SUBTITLE ${LANG_GERMAN} "MikoStorm wird nicht im Verzeichnis $INSTDIR installiert."
...
LangString InstSuccesssQuestion ${LANG_GERMAN} "MikoStorm starten?"
...
LangString CheckWindowsVersionMB ${LANG_GERMAN} 'MikoStorm unterstützt nur Windows Vista mit Service Pack 2 und höher.$\nEine Installation auf diesem Betriebssystem wird nicht unterstützt. Installation wird beendet...'
LangString CheckWindowsServPackMB ${LANG_GERMAN} "Es wird empfohlen, das aktuellste Service Pack des Betriebssystems für MikoStorm zu verwenden.$\nEs ist hilftreich für Performance und Stabilität des Programms."
...
LangString CheckAdministratorInstMB ${LANG_GERMAN} 'Sie besitzen ungenügende Berechtigungen.$\nSie müssen ein "administrator" sein, um MikoStorm installieren zu können.'

; checkifadministrator function (uninstall)
LangString CheckAdministratorUnInstDP ${LANG_GERMAN} "Überprüfung der Entfernungs-Berechtigungen ..."
LangString CheckAdministratorUnInstMB ${LANG_GERMAN} 'Sie besitzen ungenügende Berechtigungen.$\nSie müssen ein "administrator" sein, um MikoStorm entfernen zu können..'

; checkcpuflags
LangString MissingSSE2 ${LANG_GERMAN} "Dieser PC besitzt möglicherweise keinen Prozessor mit SSE2-Unterstützung, die für die Ausführung von MikoStorm ${VERSION_LONG} benötigt wird. Trotzdem installieren?"
...
LangString CloseSecondLifeInstDP ${LANG_GERMAN} "Warten auf die Beendigung von MikoStorm ..."
LangString CloseSecondLifeInstMB ${LANG_GERMAN} "MikoStorm kann nicht installiert oder ersetzt werden, wenn es bereits läuft.$\n$\nBeenden Sie, was Sie gerade tun und klicken Sie OK, um MikoStorm zu beenden.$\nKlicken Sie ABBRECHEN, um die Installation abzubrechen."
LangString CloseSecondLifeInstRM ${LANG_GERMAN} "MikoStorm konnte einige Dateien einer vorherigen Installation nicht entfernen."

; closesecondlife function (uninstall)
LangString CloseSecondLifeUnInstDP ${LANG_GERMAN} "Warten auf die Beendigung von MikoStorm ..."
LangString CloseSecondLifeUnInstMB ${LANG_GERMAN} "MikoStorm kann nicht entfernt werden, wenn es bereits läuft.$\n$\nBeenden Sie, was Sie gerade tun und klicken Sie OK, um MikoStorm zu beenden.$\nKlicken Sie CANCEL, um abzubrechen."

; CheckNetworkConnection
LangString CheckNetworkConnectionDP ${LANG_GERMAN} "Prüfe Netzwerkverbindung..."

; error during installation
LangString ErrorSecondLifeInstallRetry ${LANG_GERMAN} "MikoStorm konnte nicht korrekt installiert werden, einige Dateien wurden eventuell nicht korrekt von der Installationroutine kopiert."
...
LangString DeleteProgramFilesMB ${LANG_GERMAN} "Es existieren weiterhin Dateien in Ihrem MikoStorm Programm-Ordner.$\n$\nDies sind möglicherweise Dateien, die sie modifiziert oder bewegt haben:$\n$INSTDIR$\n$\nMöchten Sie diese ebenfalls löschen?"

; uninstall text
LangString UninstallTextMsg ${LANG_GERMAN} "Dies wird MikoStorm ${VERSION_LONG} von Ihrem System entfernen."
...
LangString DeleteRegistryKeysMB ${LANG_GERMAN} "Möchten Sie MikoStorm als Standardverknüpfung zum Öffnen von Virtuelle-Welten-Protokollen entfernen?$\n$\nEs wird empfohlen, diese zu behalten, falls Sie noch andere Versionen von MikoStorm installiert haben."

; <FS:Ansariel> Ask to create protocol handler registry entries
LangString CreateUrlRegistryEntries ${LANG_GERMAN} "Möchten Sie MikoStorm als Standardverknüpfung zum Öffnen von Virtuelle-Welten-Protokollen festlegen?$\n$\nFalls Sie andere Versionen von MikoStorm installiert haben, werden bereits bestehenden Verknüpfungen überschrieben."
...
LangString UnChatlogsNoticeMB ${LANG_GERMAN} "Diese Deinstallation löscht NICHT die MikoStorm-Chatprotokolle und andere private Dateien. Sollen diese gelöscht werden, muss das MikoStorm-Verzeichnis im Anwendungsdaten-Verzeichnis manuell gelöscht werden."
LangString UnRemovePasswordsDP ${LANG_GERMAN} "Lösche gespeicherte MikoStorm-Passwörter."
