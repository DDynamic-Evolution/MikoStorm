...
Exec=${installation_prefix}/mikostorm\n\
Icon=${installation_prefix}/mikostorm_icon.png\n\
Terminal=false\n\
Type=Application\n\
...
StartupWMClass=do-not-directly-run-mikostorm-bin"
    ...
    echo -e $desktop_entry > "${desktop_entries_dir}/mikostorm-viewer.desktop" || "Failed to install application menu!"
}
