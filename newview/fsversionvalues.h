...
#define LL_VIEWER_CHANNEL MikoStorm-ReleaseOS
#define LL_VIEWER_VERSION_MAJOR 1
#define LL_VIEWER_VERSION_MINOR 0
#define LL_VIEWER_VERSION_PATCH 10
#define LL_VIEWER_VERSION_BUILD 80871
const std::string LL_VIEWER_VERSION_GITHASH {"a18aea2e22"};
const std::string LL_VIEWER_VERSION_LL{"1.0.11"};
